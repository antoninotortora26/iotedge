...
namespace Microsoft.Azure.Devices.Edge.Agent.Core
{
    ...
    public class LoggingCommandFactory : ICommandFactory
    {
        ...
        public async Task<ICommand> PrepareUpdateOnlyAsync(IModule module, IRuntimeInfo runtimeInfo) => new LoggingCommand(await this.underlying.PrepareUpdateOnlyAsync(module, runtimeInfo), "prepareUpdateOnly", this.logger);
